...
// Product version
define(PROJECT_NAMESPACE . "PRODUCT_VERSION", "16.0.13");

// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "PHPMAKER_Contatos"); // Project name
...
$CONFIG = [
	...
	"RANDOM_KEY" => 'CgO3B22voDxd0siL', // Random key for encryption
	"ENCRYPTION_KEY" => '', // Encryption key for data protection
	"PROJECT_STYLESHEET_FILENAME" => "css/PHPMAKER_Contatos.css", // Project stylesheet file name
	...
	"PROJECT_ID" => "{EC5E5D8D-964F-4307-931C-849F6024B4A9}", // Project ID (GUID)
	...
	"CONNECTION_INFO" => [
		"DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "phpmaker_contatos_new"]
	],
	...
	"PARENT_USER_ID_FIELD_NAME" => "senha",
	...
	"UPLOAD_ALLOWED_FILE_EXT" => "msg,gif,jpg,jpeg,bmp,png,doc,docx,xls,xlsx,xlsm,pdf,zip,msg,txt", // Allowed file extensions
	"IMAGE_ALLOWED_FILE_EXT" => "gif,jpe,jpeg,jpg,png,bmp", // Allowed file extensions for images
	"DOWNLOAD_ALLOWED_FILE_EXT" => "csv,pdf,xls,doc,xlsx,xlsm,docx,txt,msg", // Allowed file extensions for download (non-image)
	...
	"IMPORT_FILE_ALLOWED_EXT" => "csv,xls,xlsx,xlsm,doc,zip,txt", // Import file allowed extensions
...
$LANGUAGES = [["pt-br","","portuguese.xml"]];
