 ...
 * Page class
 */
class contatos_delete extends contatos
{
	...
	// Page object name
	public $PageObjName = "contatos_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("contatoslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("contatoslist.php"); // Return to list
			}
		}
	}
