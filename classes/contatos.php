...
class contatos extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('contatos', 'contatos', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// avatar
		$this->avatar = new DbField('contatos', 'contatos', 'x_avatar', 'avatar', '`avatar`', '`avatar`', 200, 255, -1, TRUE, '`avatar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->avatar->Sortable = TRUE; // Allow sort
		$this->avatar->UploadAllowedFileExt = "gif,jpg,jpeg,bmp,png";
		$this->fields['avatar'] = &$this->avatar;

		// nome_completo
		$this->nome_completo = new DbField('contatos', 'contatos', 'x_nome_completo', 'nome_completo', '`nome_completo`', '`nome_completo`', 200, 255, -1, FALSE, '`nome_completo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// email
		$this->_email = new DbField('contatos', 'contatos', 'x__email', 'email', '`email`', '`email`', 200, 255, -1, FALSE, '`email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_email->Sortable = TRUE; // Allow sort
		$this->fields['email'] = &$this->_email;

		// telefone
		$this->telefone = new DbField('contatos', 'contatos', 'x_telefone', 'telefone', '`telefone`', '`telefone`', 200, 255, -1, FALSE, '`telefone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->telefone->Sortable = TRUE; // Allow sort
		$this->fields['telefone'] = &$this->telefone;

		// celular
		$this->celular = new DbField('contatos', 'contatos', 'x_celular', 'celular', '`celular`', '`celular`', 200, 255, -1, FALSE, '`celular`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->celular->Sortable = TRUE; // Allow sort
		$this->fields['celular'] = &$this->celular;

		// empresa
		$this->empresa = new DbField('contatos', 'contatos', 'x_empresa', 'empresa', '`empresa`', '`empresa`', 3, 11, -1, FALSE, '`empresa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->empresa->Sortable = TRUE; // Allow sort
		$this->empresa->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->empresa->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
		$this->empresa->Lookup = new Lookup('empresa', 'empresas', FALSE, 'id', ["nome_empreasa","","",""], [], [], [], [], [], [], '`nome_empreasa` ASC', '');
		$this->empresa->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['empresa'] = &$this->empresa;

		// cargo
		$this->cargo = new DbField('contatos', 'contatos', 'x_cargo', 'cargo', '`cargo`', '`cargo`', 3, 11, -1, FALSE, '`cargo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->cargo->Lookup = new Lookup('cargo', 'cargos', FALSE, 'id', ["nome_cargo","","",""], [], [], [], [], [], [], '`nome_cargo` ASC', '');
		$this->cargo->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['cargo'] = &$this->cargo;

		// responsabilidades
		$this->responsabilidades = new DbField('contatos', 'contatos', 'x_responsabilidades', 'responsabilidades', '`responsabilidades`', '`responsabilidades`', 200, 255, -1, FALSE, '`responsabilidades`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->responsabilidades->Sortable = TRUE; // Allow sort
		$this->fields['responsabilidades'] = &$this->responsabilidades;

		// obs
		$this->obs = new DbField('contatos', 'contatos', 'x_obs', 'obs', '`obs`', '`obs`', 200, 255, -1, FALSE, '`obs`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`contatos`";
	}
	...
	{
		return ($this->SqlOrderBy != "") ? $this->SqlOrderBy : "`empresa` ASC,`cargo` ASC,`nome_completo` ASC,`id` ASC";
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "contatosedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "contatosadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("contatosview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("contatosview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "contatosadd.php?" . $this->getUrlParm($parm);
		else
			$url = "contatosadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("contatosedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("contatosadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("contatosdelete.php", $this->getUrlParm());
	}
