 ...
 * Page class
 */
class know_base_edit extends know_base
{
	...
	// Page object name
	public $PageObjName = "know_base_edit";
	...
	protected function editRow()
	{
		...
		if ($this->titulo->CurrentValue != "") { // Check field with unique index
			$filterChk = "(`titulo` = '" . AdjustSql($this->titulo->CurrentValue, $this->Dbid) . "')";
		...
		if ($rs->EOF) {
			...
			// procedimento
			$this->procedimento->setDbValueDef($rsnew, $this->procedimento->CurrentValue, NULL, $this->procedimento->ReadOnly);
