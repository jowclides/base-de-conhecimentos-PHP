 ...
 * Page class
 */
class know_base_delete extends know_base
{
	...
	// Page object name
	public $PageObjName = "know_base_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("know_baselist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("know_baselist.php"); // Return to list
			}
		}
	}
