...
class view1 extends DbTable
{
	...
	public function __construct()
	{
		...
		// avatar
		$this->avatar = new DbField('view1', 'view1', 'x_avatar', 'avatar', '`avatar`', '`avatar`', 200, 255, -1, TRUE, '`avatar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->avatar->Sortable = TRUE; // Allow sort
		$this->avatar->UploadAllowedFileExt = "gif,jpg,jpeg,bmp,png";
		$this->fields['avatar'] = &$this->avatar;

		// nome_completo
		$this->nome_completo = new DbField('view1', 'view1', 'x_nome_completo', 'nome_completo', '`nome_completo`', '`nome_completo`', 200, 255, -1, FALSE, '`nome_completo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// telefone
		$this->telefone = new DbField('view1', 'view1', 'x_telefone', 'telefone', '`telefone`', '`telefone`', 200, 255, -1, FALSE, '`telefone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->telefone->Sortable = TRUE; // Allow sort
		$this->fields['telefone'] = &$this->telefone;

		// celular
		$this->celular = new DbField('view1', 'view1', 'x_celular', 'celular', '`celular`', '`celular`', 200, 255, -1, FALSE, '`celular`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->celular->Sortable = TRUE; // Allow sort
		$this->fields['celular'] = &$this->celular;

		// nome_empreasa
		$this->nome_empreasa = new DbField('view1', 'view1', 'x_nome_empreasa', 'nome_empreasa', '`nome_empreasa`', '`nome_empreasa`', 200, 255, -1, FALSE, '`nome_empreasa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// responsabilidades
		$this->responsabilidades = new DbField('view1', 'view1', 'x_responsabilidades', 'responsabilidades', '`responsabilidades`', '`responsabilidades`', 200, 255, -1, FALSE, '`responsabilidades`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->responsabilidades->Sortable = TRUE; // Allow sort
		$this->fields['responsabilidades'] = &$this->responsabilidades;

		// obs
		$this->obs = new DbField('view1', 'view1', 'x_obs', 'obs', '`obs`', '`obs`', 200, 255, -1, FALSE, '`obs`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
