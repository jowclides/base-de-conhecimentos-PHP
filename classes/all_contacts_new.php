...
/**
 * Table class for all_contacts_new
 */
class all_contacts_new extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'all_contacts_new';
		$this->TableName = 'all_contacts_new';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`all_contacts_new`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('all_contacts_new', 'all_contacts_new', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// avatar
		$this->avatar = new DbField('all_contacts_new', 'all_contacts_new', 'x_avatar', 'avatar', '`avatar`', '`avatar`', 200, 255, -1, FALSE, '`avatar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->avatar->Sortable = TRUE; // Allow sort
		$this->fields['avatar'] = &$this->avatar;

		// nome_completo
		$this->nome_completo = new DbField('all_contacts_new', 'all_contacts_new', 'x_nome_completo', 'nome_completo', '`nome_completo`', '`nome_completo`', 200, 255, -1, FALSE, '`nome_completo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// email
		$this->_email = new DbField('all_contacts_new', 'all_contacts_new', 'x__email', 'email', '`email`', '`email`', 200, 255, -1, FALSE, '`email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_email->Sortable = TRUE; // Allow sort
		$this->fields['email'] = &$this->_email;

		// telefone
		$this->telefone = new DbField('all_contacts_new', 'all_contacts_new', 'x_telefone', 'telefone', '`telefone`', '`telefone`', 200, 255, -1, FALSE, '`telefone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->telefone->Sortable = TRUE; // Allow sort
		$this->fields['telefone'] = &$this->telefone;

		// celular
		$this->celular = new DbField('all_contacts_new', 'all_contacts_new', 'x_celular', 'celular', '`celular`', '`celular`', 200, 255, -1, FALSE, '`celular`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->celular->Sortable = TRUE; // Allow sort
		$this->fields['celular'] = &$this->celular;

		// empresa
		$this->empresa = new DbField('all_contacts_new', 'all_contacts_new', 'x_empresa', 'empresa', '`empresa`', '`empresa`', 3, 11, -1, FALSE, '`empresa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->empresa->Sortable = TRUE; // Allow sort
		$this->empresa->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['empresa'] = &$this->empresa;

		// cargo
		$this->cargo = new DbField('all_contacts_new', 'all_contacts_new', 'x_cargo', 'cargo', '`cargo`', '`cargo`', 3, 11, -1, FALSE, '`cargo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// responsabilidades
		$this->responsabilidades = new DbField('all_contacts_new', 'all_contacts_new', 'x_responsabilidades', 'responsabilidades', '`responsabilidades`', '`responsabilidades`', 200, 255, -1, FALSE, '`responsabilidades`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->responsabilidades->Sortable = TRUE; // Allow sort
		$this->fields['responsabilidades'] = &$this->responsabilidades;

		// obs
		$this->obs = new DbField('all_contacts_new', 'all_contacts_new', 'x_obs', 'obs', '`obs`', '`obs`', 200, 255, -1, FALSE, '`obs`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`all_contacts_new`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "all_contacts_newlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "all_contacts_newview.php")
			return $Language->phrase("View");
		elseif ($pageName == "all_contacts_newedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "all_contacts_newadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("all_contacts_newview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("all_contacts_newview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "all_contacts_newadd.php?" . $this->getUrlParm($parm);
		else
			$url = "all_contacts_newadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("all_contacts_newedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("all_contacts_newadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("all_contacts_newdelete.php", $this->getUrlParm());
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->avatar->setDbValue($rs->fields('avatar'));
